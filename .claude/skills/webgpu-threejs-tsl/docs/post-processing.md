...
// Anamorphic lens flare: removed as a standalone node in r185.
// Inject a custom high-pass filter into bloom() instead (see BloomNode `highPassNode`).
...
import { boxBlur } from 'three/addons/tsl/display/boxBlur.js';       // Mobile-friendly
import { hashBlur } from 'three/addons/tsl/display/hashBlur.js';     // Single-pass

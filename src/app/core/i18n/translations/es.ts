export const ES_TRANSLATIONS: Record<string, string> = {
  ...
  'education.subtitlePipeline': 'Cada título es un job — ejecútalos todos',
  'education.jobs': 'jobs',
  'education.passed': 'superados',
  'education.run': 'ejecutar',
  'education.running': 'corriendo…',
  'education.passedOne': 'superado ✓',
  'education.achievement': 'Logro desbloqueado: carrera compilada sin errores',
  'tech.title': 'Mi Stack',
  ...
  'world.zone.about': 'Quién soy',
  'world.zone.experience': 'Trayectoria',
  'world.zone.stack': 'Mi stack',
  'world.zone.projects': 'Proyectos',
  'world.zone.software': 'Software',
  'world.zone.daily': 'Mi día a día',
  'world.zone.value': 'Para empresas',
  'world.zone.contact': 'Escríbeme',
  'world.enter': 'Entrar',
  'world.hint': 'WASD mover · espacio saltar · F ejecuta un comando de IA contra la máquina más cercana · C centra',
  'world.loading': 'Construyendo el mundo…',
  'world.explore': 'Explora el mundo',
  'world.fallbackTitle': 'Navega el sitio',
  'world.fallbackBody': 'Tu navegador no puede mostrar el mundo 3D, pero todo el contenido sigue aquí.',
  'world.jump': 'Saltar',
  'world.lives': 'Vidas',
  'world.command': 'Ejecutar comando',
  'world.machines': 'Máquinas',
  'world.soundOff': 'Sonido desactivado',
  'world.soundOn': 'Sonido activado',
  'world.debt': 'DEUDA TÉCNICA',
  'world.findings': 'Hallazgos resueltos',
  'world.simulated': 'Análisis del juego',
  'world.objective': 'Lee, comprende y corrige con F. Tus perros te acompañan.',
  'world.victory': 'Deuda técnica eliminada. Código limpio.',
  'world.defeat': 'La deuda sigue en pie. Tus máquinas reparadas se conservan.',
  'world.dodge': '¡Descarga! Muévete fuera de las líneas o salta.',
  'world.appearing': 'La deuda técnica despierta…',
  'world.scanHint': 'Lee al jefe y descubre sus errores · Q',
  'world.approach': 'Acércate al jefe para refactorizar.',
  'world.waitOpening': 'Esquiva su descarga. Su núcleo se abrirá después.',
  'world.refactorHint': '¡Núcleo abierto! Usa F para corregir un hallazgo.',
  'world.scan': 'Leer y analizar',
  'world.refactor': 'Poder del libro',
  'world.move': 'Mover',
  'world.retry': 'Reintentar encuentro',
  'world.companions': 'Poderes de tus compañeros',
  'world.supportReady': 'Pulso listo',
  'world.recharging': 'Recargando',
  'world.cameraMouseHint': 'Arrastrar: girar · Botón derecho: desplazar · Rueda: zoom · C: centrar',
  'world.cameraTouchHint': 'Un dedo: mover · Dos dedos: cámara y zoom',
  'world.zoomOut': 'Alejar cámara',
  'world.centerCamera': 'Centrar cámara · C',
  'world.zoomIn': 'Acercar cámara',
  'world.findingCopy': 'Copia y pega',
  'world.findingTests': 'Código sin pruebas',
  'world.findingComplexity': 'Complejidad excesiva',
  'world.radar': 'Máquinas pendientes en naranja; tu posición en azul',
};

export const ES_TRANSLATIONS: Record<string, string> = {
  ...
  'software.title': 'Software que he construido',
  'software.subtitle': 'Productos reales — despliega cada uno y descúbrelo',
  'software.services': 'servicios',
  'software.deploy': 'desplegar',
  'software.online': 'en línea',
  'software.visit': 'visitar',
  'software.builtWith': 'hecho con',
  'software.collapse': 'Plegar el detalle',
  'software.expand': 'Abrir el detalle',
